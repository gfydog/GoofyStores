...
// Check if the user is not logged in. If not logged in, display a message and exit.
...
try {
    ...
    $stmt_check->bind_param("ii", $_SESSION['user_id'], $product_id);
    $stmt_check->execute();
    ...
    if ($stmt_check->num_rows > 0) {
        ...
        if ($quantity > 1) {
            ...
            $stmt_update->bind_param("ii", $_SESSION['user_id'], $product_id);
            ...
            $stmt_delete->bind_param("ii", $_SESSION['user_id'], $product_id);
