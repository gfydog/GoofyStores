 ...
 *
 * This script allows administrators to reset their passwords by generating a new random password,
 * updating it in the database, and sending the new password to their registered email address.
 *
 * PHP version 7
 *
