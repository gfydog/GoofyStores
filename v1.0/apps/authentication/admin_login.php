 ...
 * Admin Login Page
 *
 * This script handles the admin login process. It checks if the admin is already authenticated,
 * and if not, allows them to log in by providing a username and password.
 *
 * PHP version 7
 *
