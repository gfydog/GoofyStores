<?php
/**
 * Admin Category Management Script
 *
 * This script allows administrators to manage categories in a web application. Administrators can add and delete categories.
 *
 * PHP version 7
 *
